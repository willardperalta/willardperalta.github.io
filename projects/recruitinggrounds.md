...
labels:
  ...
  - Webapp
  - React
summary: A web application I made with a team for my software engineering class at UH Manoa in Fall 2018. The purpose of the app is to allow students and companies to easily network with each other.
---
...
<a href="https://github.com/twt-connections"><i class="large youtube icon"></i>Here is a link to our organization Github page with the project's source code.</a>